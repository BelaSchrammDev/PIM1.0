...
namespace IngameScript
{
    partial class Program
    {
        void SendInfosToSMS()
        {
            ...
            {
                if (p.Enabled && p.DetailedInfo.StartsWith(Strings.SmsVersion) && !LoopManager.firstRun)
                {
                    var s = "";
                    ...
                    foreach (var c in Lists.Data.CargoUseList.Values) s += "@CARGOUSE;" + c.type + ";" + c.Current + ";" + c.Maximum + "\n";
